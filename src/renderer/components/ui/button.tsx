...
const buttonVariants = cva(
  'cursor-pointer rounded-full inline-flex active:text-primary-foreground active:border-accent-secondary active:bg-accent-secondary items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-40',
  {
    variants: {
      variant: {
